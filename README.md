...
## From Github Release
### Ubuntu
1. `$ wget https://github.com/45Drives/cockpit-samba-manager/releases/download/v1.0.3/cockpit-samba-manager_1.0.3-1focal_all.deb`
1. `# dpkg -i cockpit-samba-manager_1.0.3-1focal_all.deb`
1. [Edit Samba configuration](#samba-configuration)
### RHEL7
1. `# yum install https://github.com/45Drives/cockpit-samba-manager/releases/download/v1.0.3/cockpit-samba-manager-1.0.3-1.el7.noarch.rpm`
1. [Edit Samba configuration](#samba-configuration)
## From Source
